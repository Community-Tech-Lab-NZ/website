    ...
    return (
      <p className="max-w-measure font-sans text-body-sm text-muted">
        ...
        <button
          ...
          className="cursor-pointer border-0 bg-transparent p-0 font-sans text-body-sm text-ink underline decoration-kowhai underline-offset-[var(--link-underline-offset)] transition-[text-decoration-color] duration-[var(--duration-fast)] ease-brand hover:decoration-fern"
        >
